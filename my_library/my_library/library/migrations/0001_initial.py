# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-24 12:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charge', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='GBP', max_digits=10)),
                ('returned', models.BooleanField(default=False)),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book_borrows', to='library.Book')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book_borrows', to='users.User')),
            ],
        ),
        migrations.CreateModel(
            name='Library',
            fields=[
                ...
                ('librarian', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='library', to='users.User')),
            ],
        ),
        migrations.AddField(
            model_name='book',
        ...
        migrations.AlterUniqueTogether(
            name='bookborrow',
            unique_together=set([('book', 'user', 'start_date')]),
        ),
    ]
